...
date: '2026-05-03'
summary: 'El debate ya no es "managed vs bare". Con CNG, development builds y la recomendación oficial de Meta, la pregunta cambió por completo. Te explico cuándo elegir cada uno.'
tags: ['React Native', 'Expo', 'Mobile', 'TypeScript', 'Tooling']
---
...
| Característica          | EAS Build                               | Build manual/local                |
| ----------------------- | --------------------------------------- | --------------------------------- |
| Compilación en la nube | Android (Linux) + iOS (macOS cloud)     | Necesitas Mac para iOS            |
| Manejo de credenciales  | Auto-generadas y almacenadas           | Manual (keystore/certificados)    |
| Distribución interna    | Comparte builds via URL                 | Sideloading manual / TestFlight  |
| Integración con CNG     | Auto-prebuild si no hay `android/`/ios/ | Manual                            |
| Costo                   | 30 builds/mes gratis (Android), 15 (iOS)| Solo costo de computo            |
...
Desde junio 2024, el blog oficial de React Native establece que ["you're either using a framework or you're building your own"](https://reactnative.dev/blog/2024/06/25/use-a-framework-to-build-react-native-apps) — y recomienda explícitamente Expo como framework.
...
| Criterio                 | Expo (2026)                              | React Native CLI                    |
| ------------------------ | ---------------------------------------- | ------------------------------------ |
| Setup inicial            | 1 comando, sin Xcode/Android Studio      | Configuración manual del entorno    |
| Módulos nativos          | Cualquiera via development builds        | Cualquiera, edición manual          |
| Actualización de RN      | Bump + prebuild, sin conflictos          | Merge manual, alto riesgo           |
| Navegación               | Expo Router (file-based, tipado, SSG)   | React Navigation (manual)           |
| Builds en la nube        | EAS Build (integrado)                    | CI/CD manual (Fastlane, etc.)       |
| Deep linking             | Automático                               | Manual                               |
| OTA Updates              | EAS Update                               | CodePush (retirado) o custom        |
| Código nativo            | Expo Modules API (Swift/Kotlin)          | Edición directa en android/ ios/    |
| Curva de aprendizaje     | Menor                                    | Mayor                                |
| Flexibilidad nativa      | Alta (con config plugins o prebuild)    | Total                                |
...
- [Use a Framework to Build React Native Apps](https://reactnative.dev/blog/2024/06/25/use-a-framework-to-build-react-native-apps) — Blog oficial de React Native (junio 2024)
- [Expo Docs: Why Expo CLI instead of React Native CLI](https://docs.expo.dev/bare/using-expo-cli) — Comparativa oficial de Expo
- [Continuous Native Generation (CNG)](https://docs.expo.dev/workflow/continuous-native-generation) — Documentación oficial
- [Expo Router](https://docs.expo.dev/router/introduction) — File-based routing universal
- [Development Builds](https://docs.expo.dev/develop/development-builds/introduction) — La alternativa a Expo Go para producción
- [EAS Build](https://docs.expo.dev/build/introduction) — Cloud builds para iOS y Android
- [Install Expo Modules in existing RN projects](https://docs.expo.dev/bare/installing-expo-modules) — Adopción incremental
- [Config Plugins](https://docs.expo.dev/guides/config-plugins) — Modificar código nativo sin eject